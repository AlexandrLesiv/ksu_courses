 ...
 * @property string|null $rule_name Назва правила
 * @property resource|null $data Дані
 * @property int|null $created_at Створено
 * @property int|null $updated_at Відредаговано
 *
